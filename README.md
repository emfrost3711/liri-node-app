...
# LIRI Bot
it might yell at you bc you don't have a file but just ignore it for now
### Overview
...
Spotify Info:
Client ID acc06edfb1454711894d4a6a8fff8233
Client Secret dd5e5f32afd14c289b73f4734ef1c32f 
...
* You should then be able to access your keys information like so
  ...
  ```
SET UP THROUGH THIS PART BEFORE SATURDAY
...
9. Make it so liri.js can take in one of the following commands:
   ...
   * `do-what-it-says` must read the txt and then do what it says MAKE A FUNCTION WITH A SWITCH CASE IN IT remember to use placeholders NOT the actual words as the method in the functions when you are creating them. When you build this start with do-what-it-says first; and console log a lot. do the axios calls later; be sure you can console log the actions and the values out all of the switch cases in your switch case before worrying about axios.
...
The Liri Bot is your best friend when it comes to quickly garnering information about your favorite artists' upcoming shows, retrieving data from spotify, or getting the skinny on your favorite movies. Here's how to use Liri. 

  - When you open the file, you'll need to be sure you have a few requirements installed. Check all of the required elements stored in variables at the start of the code. 
  - Before every call for information, use "node liri.js", then enter the command followed by the search terms. For example, in your terminal/bash, type "node liri.js concert-this lizzo". And then see when she's coming to your town and buy tickets immediately because Lizzo live is lifechanging. 
  - The commands you can choose from include: `spotify-this`, `movie-this`, `concert-this`, and `do-what-it-says`. Try them out and see which results you get!
  

Shout out and thanks to the following websites for making this digital friend's existence possible: [node Spotify API](https://www.npmjs.com/package/node-spotify-api) [OMDB API](http://www.omdbapi.com) and the [Bands In Town API](http://www.artists.bandsintown.com/bandsintown-api).
>>>>>>> e851a51a1062a882098d05884461084b7e431a1b
